    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      <Grid container spacing={4} sx={{ mb: 6 }} alignItems="center">
        <Grid item xs={12} md={8}>
          ...
          <Typography variant="body1" paragraph sx={{ fontSize: '1.1rem', lineHeight: 1.7, color: theme.palette.text.secondary }}>
            My journey began in 2007 in technical support roles, where I gained firsthand experience with real-world systems and user needs. That foundation still informs my work today — I believe great software starts with empathy for the end user and an obsession with operational excellence.
          </Typography>
          <Typography variant="body1" paragraph sx={{ fontSize: '1.1rem', lineHeight: 1.7, color: theme.palette.text.primary }}>
            Over the years, I’ve grown into a full-stack engineer fluent in Java, TypeScript, and modern cloud ecosystems — particularly AWS, where I’m actively completing advanced architecture certifications.
          </Typography>
          <Typography variant="body1" paragraph sx={{ fontSize: '1.1rem', lineHeight: 1.7, color: theme.palette.text.secondary }}>
            I'm especially passionate about clean system design, developer experience, and mentoring newer engineers. When I’m not refining backend infrastructure or pushing pixels on a UI, I’m likely hiking Minnesota’s trails or working on new tools under the ZennLogic banner.
          </Typography>
        </Grid>
                ...
                <CardContent sx={{ p: 3 }}>
                  <Avatar
                    sx={{
                      ...
                      mx: 'auto',
                      mb: 2,
                      bgcolor: highlight.color === 'primary' ? theme.palette.primary.main :
                              highlight.color === 'secondary' ? theme.palette.secondary.main :
                              highlight.color === 'success' ? theme.palette.success.main :
