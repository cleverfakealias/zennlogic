            ...
            <Card 
              sx={{ 
                ...
                '&::before': {
                  ...
                  height: '4px',
                  background: 
                    experience.color === 'primary' ? `linear-gradient(90deg, ${theme.palette.primary.main}, ${theme.palette.primary.light})` :
                    experience.color === 'secondary' ? `linear-gradient(90deg, ${theme.palette.secondary.main}, ${theme.palette.secondary.light})` :
                    experience.color === 'success' ? `linear-gradient(90deg, ${theme.palette.success.main}, ${theme.palette.success.light})` :
                    experience.color === 'warning' ? `linear-gradient(90deg, ${theme.palette.warning.main}, ${theme.palette.warning.light})` :
                    experience.color === 'error' ? `linear-gradient(90deg, ${theme.palette.error.main}, ${theme.palette.error.light})` :
                ...
                <Box sx={{ display: 'flex', alignItems: 'flex-start', mb: 3 }}>
                  <Box
                    ...
                    sx={{
                      ...
                      borderRadius: '16px',
                      background: 
                        experience.color === 'primary' ? `linear-gradient(135deg, ${theme.palette.primary.main}, ${theme.palette.primary.dark})` :
                        experience.color === 'secondary' ? `linear-gradient(135deg, ${theme.palette.secondary.main}, ${theme.palette.secondary.dark})` :
                        experience.color === 'success' ? `linear-gradient(135deg, ${theme.palette.success.main}, ${theme.palette.success.dark})` :
                        experience.color === 'warning' ? `linear-gradient(135deg, ${theme.palette.warning.main}, ${theme.palette.warning.dark})` :
                        experience.color === 'error' ? `linear-gradient(135deg, ${theme.palette.error.main}, ${theme.palette.error.dark})` :
