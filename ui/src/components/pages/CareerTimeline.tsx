...
const timelineData: TimelineItemData[] = [
  {
    ...
    description: 'Seasoned Software Developer working on enterprise SaaS applications, focusing on scalable cloud solutions and modern web technologies.',
  ...
  },
  {
    ...
    description: 'Managed technical support team for web development and email hosting services in the Real Estate industry, leading a team of 8+ support representatives.',
    timestamp: '2012 - 2017',
    startDate: '2012',
    color: 'secondary',
    icon: <Business />,
  },
  {
    ...
    description: 'Provided comprehensive technical support for CD and DVD replication and printing devices, troubleshooting hardware and software issues.',
    timestamp: '2007 - 2012',
    startDate: '2007',
    color: 'success',
    icon: <Support />,
