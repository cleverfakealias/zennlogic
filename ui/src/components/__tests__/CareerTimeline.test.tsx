...
describe("CareerTimeline", () => {
  ...
  test("renders all career positions", () => {
    ...
    expect(
      screen.getByText("Technical Support Representative"),
    ).toBeInTheDocument();
  });
  ...
  test("renders job descriptions", () => {
    ...
    expect(
      screen.getByText(/Managed technical support team for web development/),
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        /Provided comprehensive technical support for CD and DVD replication/,
      ),
    ).toBeInTheDocument();
  });
