...
describe('DevelopmentExperience', () => {
  ...
  test('renders development experience subtitle', () => {
    renderWithTheme(<DevelopmentExperience />);
    expect(screen.getByText('Technical expertise spanning full-stack development, modern frameworks, and enterprise solutions')).toBeInTheDocument();
  });
  ...
  test('renders experience descriptions', () => {
    ...
    expect(screen.getByText(/Skilled in building modern, responsive user interfaces/)).toBeInTheDocument();
    expect(screen.getByText(/Proficient in back-end development with Java and Python/)).toBeInTheDocument();
    expect(screen.getByText(/Experienced with a variety of database systems/)).toBeInTheDocument();
    expect(screen.getByText(/Hands-on experience with modern DevOps pipelines/)).toBeInTheDocument();
