...
import { Avatar, useTheme, Menu, MenuItem, IconButton, Tooltip } from "@mui/material";
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="footer" role="contentinfo" aria-label="Site footer" style={{ padding: '0 24px' }}>
      <div className="footer-content" style={{
        ...
        <div className="footer-cell-left" style={{ textAlign: "left", display: 'flex', alignItems: 'center', gap: '0.75rem', height: '100%' }}>
          <Avatar
        ...
        <div className="footer-cell-center" style={{ textAlign: "center" }}>
          <p style={{ margin: 0 }}>&copy; {new Date().getFullYear()} Ben Hickman. All rights reserved.</p>
          <p style={{ margin: 0 }}>
            Built with love <span role="img" aria-label="love">❤️</span> by Ben Hickman using React, Vite, and Sanity.
          </p>
        </div>
        {/* Right cell: Quick links dropdown and social links */}
        <div className="footer-cell-right" style={{ textAlign: "right", display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: '0.5rem' }}>
